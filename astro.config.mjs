...
export default defineConfig({
  ...
  integrations: [starlight({
      ...
      sidebar: [
        ...
        { label: 'Types & Data', collapsed: true, items: [{ autogenerate: { directory: 'types-data' } }] },
        { label: 'Methods & Interfaces', collapsed: true, items: [{ autogenerate: { directory: 'methods-interfaces' } }] },
        { label: 'Concurrency', collapsed: true, items: [{ autogenerate: { directory: 'concurrency' } }] },
        { label: 'Errors & Generics', collapsed: true, items: [{ autogenerate: { directory: 'errors-generics' } }] },
        { label: 'Standard Library', collapsed: true, items: [{ autogenerate: { directory: 'stdlib' } }] },
