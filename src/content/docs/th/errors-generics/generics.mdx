...
สองกฎที่ต้องจำ: **method ใน interface ประกาศ type parameter ไม่ได้** และ generic method จึงใช้ satisfy interface ไม่ได้ generic method ต้องใช้ Go 1.27+ (`go 1.27` ใน `go.mod`) ส่วน playground ใน browser รัน interpreter รุ่นเก่ากว่า ลองรันตัวอย่างนี้บน go.dev/play แทน
