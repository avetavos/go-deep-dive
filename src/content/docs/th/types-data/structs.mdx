...
> 💡 ตัวอย่างจากของจริง
>
> **`bufio.ReadWriter`** (stdlib) เป็น struct ที่ embed `*Reader` และ `*Writer` เข้าด้วยกัน — ได้ method ของทั้งสองมาโดยไม่ต้อง implement เอง และ satisfy `io.ReadWriter` ทันที
